...
<?php while ( have_posts() ) : the_post(); ?>
  <section class="home-banner" id="banner">
    <div class="container">
      ...
      <div class="el__tea">
        <video class="video wow fadeIn" style="clip-path: url(#smoke-clip);" width="480" height="852" src="<?= get_theme_file_uri('assets/videos/smoke.mp4') ?>" muted autoplay loop></video>
  ...
  <section class="home-thanks text-center">
    <div class="container">
      <h2 class="home-thanks__title fm-vanilla wow fadeInUp"><?php the_field('thanks_title') ?></h2>
      <div class="home-thanks__content wow fadeInUp"><?php the_field('thanks_content') ?></div>
    </div>
    <div class="leaf-img leaf-left wow fadeInLeft"><img src="<?= get_theme_file_uri('assets/img/leaf-img01.png') ?>" alt=""></div>
    <div class="leaf-img leaf-center wow fadeInUp"><img src="<?= get_theme_file_uri('assets/img/leaf-img02.png') ?>" alt=""></div>
    <div class="leaf-img leaf-top wow fadeInDown"><img src="<?= get_theme_file_uri('assets/img/leaf-img03.png') ?>" alt=""></div>
