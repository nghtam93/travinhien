    ...
    if( $query->have_posts() ):?>
        <div class="related__post <?php echo $post_type; ?>">
            <div class="el__header">
                <h3 class="el__header__title"><img src="<?php echo get_theme_file_uri('assets/img/home-new-icon-01.png') ?>" width="32" height="32" alt=""> <?php echo $related_title ?></h3>
            </div>
            <?php  ?>
...
function dntheme_get_wmpl($value='')
{
    if(in_array('wpml-translation-management/plugin.php', apply_filters('active_plugins', get_option('active_plugins')))){
        ...
        echo "<img src='".get_theme_file_uri('assets/flag/'.$currentLang.'.png')."' width='".$flag_width."' height='".$flag_height."' >";
        echo '</div>';
        echo '<ul class="">';
